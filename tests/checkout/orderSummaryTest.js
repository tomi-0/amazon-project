...
describe('test suite: renderOrderSummary', () => {
    ...
    it('displays the cart', () => {
        ...
        // displays correct product price
        expect(
...
describe('test suite: updateDeliveryOption', () => {
    ...
    it('updates delivery option of a product if its in the cart', () => {
    ...
    it('does nothing if product isnt in cart', () => {
        updateDeliveryOption('doesnt-exist', 2);
        expect(cart[0].deliveryOptionId).toEqual(1);
        expect(cart.length).toEqual(2);
        expect(localStorage.setItem).toHaveBeenCalledTimes(0);
    })

    it('does nothing with invalid delivery option', () => {
